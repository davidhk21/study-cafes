...
const CityPage = async ({ params }: {
  ...
  return (
    <div className="">
      ...
      <div className="h-[100vh] flex items-center justify-center w-[80%] mx-auto">
        <Image 
          src={selectedCafe.photos[1]}
          alt={selectedCafe.name}
          className="flex-1 max-w-[600px] max-h-[800px] w-auto h-auto shadow-2xl"
        />
        <div className="flex-1 flex flex-col justify-center w-[50%] ml-12 max-w-[500px]">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center w-[80%] mx-auto my-20">
        ...
        <div className="flex flex-col justify-center w-[50%] max-w-[500px] ml-20">
      ...
      <div className="w-full h-[100vh] flex flex-col justify-center items-center">
        <Image 
          ...
          alt={selectedCafe.name}
          className="aspect-video max-w-[1000px] max-h-[700px] w-auto h-auto mb-12 shadow-2xl"
        />
        <div className="flex flex-col items-center w-[50%] max-w-[700px] ml-12">
          <h2 className="mb-6 font-libre tracking-widest text-content-title">AESTHETIC</h2>
          <p className="font-sans leading-loose text-lg">Some really long description that has a bunch of words about the cafe and my personal opinion about thte cafe or what I like about the cafe that makes it worth adding to the list of cafes that I recommend</p>
        </div>
      </div>

      <div className="flex flex-col md:flex-row justify-center items-center w-[80%] h-[60vh] mx-auto py-12">
        <iframe
          className="min-w-[250px] min-h-[300px] max-w-[700px] w-full h-full"
          loading="lazy"
          allowFullScreen
          referrerPolicy="no-referrer-when-downgrade"
          src={`https://www.google.com/maps/embed/v1/place?key=${process.env.GOOGLE_MAPS_API_KEY}&q=${selectedCafe.mapsQuery}`}>
        </iframe>
        <div className="flex flex-col justify-center w-[50%] max-w-[500px] ml-12">
